            ...
            let ifaces: Vec<Value> = stats
                ...
                .map(|i| {
                    json!({
                        ...
                        "cpu_load": i.cpu_load,
                        "mem_load": i.mem_load,
                        "switch_id": i.switch_id.map(|value| to_hex(&value)),
                        "endpoint_id": i.endpoint_id.map(|value| to_hex(&value)),
                        "via_switch_id": i.via_switch_id.map(|value| to_hex(&value)),
                        "peers": i.peers,
                        "bitrate": i.bitrate,
                        "started": i.started,
                        "ia_freq": i.ia_freq,

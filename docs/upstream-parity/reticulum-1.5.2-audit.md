...
| 30 | `dc9cf0c2f4f3432283148abc82146301682aaf99` | Updated setup.py | Non-runtime | Full diff review: changes the default Cython native-wheel optimization from `-Os` to `-O3`; Rust optimization profiles are independently defined by Cargo |

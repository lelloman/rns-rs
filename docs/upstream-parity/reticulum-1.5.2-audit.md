...
| 23 | `e714c559cc00ce4d7abc232a86a62d5d3b5c7376` | Updated tests init | Non-runtime | Full diff review: switches upstream tests between CRNS compiled and interpreted imports via `RNS_COMPILE` and prints the selected Python mode; no native test/runtime surface changes |

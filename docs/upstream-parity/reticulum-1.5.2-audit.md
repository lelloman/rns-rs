...
| 29 | `fa07c8c87c33d2408e9560e1e8367cab1991b85c` | Updated setup.py | Non-runtime | Full diff review: refines the native-wheel exclusion set from whole rngit/rnsh packages to explicit utility modules and adds rnpath, rnprobe, rnstatus, and `_version`; no Rust artifact changes |

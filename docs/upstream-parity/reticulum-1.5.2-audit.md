...
| 36 | `ccc5468bcc65842f9c44c8d80249df7645033297` | Updated changelog | Non-runtime | Full diff review: adds the 1.5.1 release narrative and moves the unchanged signed-retrieval instructions; compatibility claims remain inventory context, not acceptance evidence |

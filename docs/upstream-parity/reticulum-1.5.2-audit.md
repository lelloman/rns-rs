...
| 38 | `149e4151095adf098b8f53eab0c03b37169e8559` | Prepare release | Non-runtime | Full diff review: regenerates 1.5.1 Sphinx/Markdown output, fixes documented queue defaults to 1024/128/128/8, and changes no source runtime; native defaults are verified from code/tests rather than vendored generated docs |

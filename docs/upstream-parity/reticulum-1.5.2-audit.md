...
| 32 | `b28f5ebf7a4fbedbbedafd539d9d33d2f1992a9e` | Allow inbound queue utilization in drainer benchmarks | Non-runtime | Full diff review: benchmark pacing waits only to `target - 800`, intentionally leaving most of the assumed 1024-entry queue occupied; production code and native acceptance limits are unchanged |

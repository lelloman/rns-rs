...
|---:|---|---|---|---|
| 1 | `2f29b56e96bfa6fd3fc61518e4e5710ac8e92258` | Adjusted logging | Structurally covered | `c28faa11480374ae234c5534325171d9f420d568`; see per-commit analysis and recorded validation. |
| 2 | `1a7e9e31a1c1682732ee84953acd3a3d758d22d5` | Fixed typo | Non-runtime | `500814c`; see per-commit analysis and recorded validation. |
| 3 | `6b6dd73bc86fedb945f6d0d55d83dc8d5e4a3241` | Updated readme | Non-runtime | `a63e9e5`; see per-commit analysis and recorded validation. |
| 4 | `5c1141d1cefd99cf17042e2b147b62abeb05526a` | Updated readme | Non-runtime | `ba2e8e3`; see per-commit analysis and recorded validation. |
| 5 | `8a82a50fc96354dc9df77d95af8aca97099629d2` | Updated readme | Non-runtime | `8a330f5`; see per-commit analysis and recorded validation. |
| 6 | `7396e3994e678a7ad009f146fca1d645b31f3e67` | Basic rngit media handling | Integrated | `2869eac`; see per-commit analysis and recorded validation. |
| 7 | `602d52f17813f3b55e78629cc83121349be72467` | Don't auto-compress media responses | Integrated | `8de4c19`; see per-commit analysis and recorded validation. |
| 8 | `27910f25a1d028359851fb8f512254cccfece7e3` | Added rngit media conversion | Integrated | `c11d345`; see per-commit analysis and recorded validation. |
| 9 | `0bb41bf9486c1469854876a3c1d7c57324efc7c4` | Updated version | Non-runtime | `c69b1fd`; see per-commit analysis and recorded validation. |
...
- [x] Every upstream commit has a final disposition and ordered local mapping.
...
- `2026-09-07`: Integrated the eight new commits in ancestry order on
  `upstream/reticulum-1.5.3`; retained the existing logging mapping. Complete
  changed-crate suites, focused media/file regressions, installed WebP backend
  test, exact-target Python media interoperability, formatting and warning-free
  lint passed as detailed above. Baseline promotion remains pending the broader
  workspace/release gates; no final parity record or deployment is claimed.
- `2026-09-07`: `cargo check --workspace --all-targets --features rns-hooks-native`
  passed, including all consumers of the new file-response API. This is a

...
[![upstream Reticulum](https://img.shields.io/badge/upstream%20Reticulum-1.5.4-blue)](UPSTREAM.md)
...
Committed conformance vectors retain their historical, pinned Reticulum 1.4.0 provenance. The current upstream reference is Reticulum 1.5.4, validated against its exact canonical commit separately from the GitHub-backed interop CI pin; see [UPSTREAM.md](UPSTREAM.md) for the exact commits and acceptance scope.

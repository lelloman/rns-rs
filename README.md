...
[![upstream Reticulum](https://img.shields.io/badge/upstream%20Reticulum-1.5.4-blue)](docs/upstream-parity/reticulum-1.5.4-rgit-3-parity.md)
...
Committed conformance vectors retain their historical, pinned Reticulum 1.4.0 provenance. The current upstream reference is Reticulum 1.5.4 at canonical commit `99de23c0`, a documentation-only advancement with an unchanged runtime tree. Exact-target interop was not rerun for this advancement; see [UPSTREAM.md](UPSTREAM.md) and the [parity record](docs/upstream-parity/reticulum-1.5.4-rgit-3-parity.md) for the accepted commit, validation evidence, and the separate GitHub-backed interop CI pin.
